...
// ────────────────────────────────────────────────────────────
const TOWER_DEF = {
  unit:        { name:'Unit Test',    cost:50,  hot:'1', color:'#22c55e', icon:'🧪', range:95,  fireRate:550,  dmg:{off_by_one:32,floating_point:10,race_condition:6,timezone:8,state_mutation:28,silent_failure:8,permission_esc:0,idempotency:10,memory_leak:10,boss:8,megaboss:5},     pColor:'#86efac', flakyRate:0.35, desc:'Fast fire, short range. Destroys off-by-one bugs (x3 dmg).' },
  cypress:     { name:'Cypress',      cost:200, hot:'2', color:'#69d3a7', icon:'🌲', range:110, fireRate:500,  dmg:{off_by_one:30,floating_point:26,race_condition:8,timezone:8,state_mutation:24,silent_failure:12,permission_esc:10,idempotency:15,memory_leak:14,boss:7,megaboss:5},    pColor:'#6ee7b7', flakyRate:0.55, retry:true, desc:'Fast, short-mid range. Retries flaky misses. Strong vs unit and interface bugs.' },
  selenium:    { name:'Selenium',     cost:250, hot:'3', color:'#f97316', icon:'Se', range:130, fireRate:1200, dmg:{off_by_one:22,floating_point:35,race_condition:28,timezone:14,state_mutation:22,silent_failure:18,permission_esc:18,idempotency:20,memory_leak:20,boss:18,megaboss:15}, pColor:'#fdba74', flakyRate:0.9, desc:'Slow, mid range. Interface specialist. High flakiness, retryable.' },
  playwright:  { name:'Playwright',   cost:350, hot:'4', color:'#2dd4bf', icon:'🎭', range:145, fireRate:1700, dmg:{off_by_one:14,floating_point:18,race_condition:42,timezone:16,state_mutation:18,silent_failure:22,permission_esc:30,idempotency:25,memory_leak:26,boss:42,megaboss:35}, pColor:'#5eead4', flakyRate:0.85, multishot:2, desc:'Parallel, mid range. Fires at 2 targets simultaneously.' },
  postman:     { name:'Postman',      cost:180, hot:'5', color:'#FF6C37', icon:'📮', range:115, fireRate:780,  dmg:{off_by_one:18,floating_point:45,race_condition:20,timezone:14,state_mutation:24,silent_failure:50,permission_esc:30,idempotency:25,memory_leak:35,boss:12,megaboss:10}, pColor:'#ffb899', flakyRate:0.5, desc:'Fast, short-mid range. Best vs floating point and silent failure bugs.' },
  integration: { name:'Integration',  cost:150, hot:'6', color:'#3b82f6', icon:'🔗', range:125, fireRate:1400, dmg:{off_by_one:14,floating_point:38,race_condition:16,timezone:10,state_mutation:18,silent_failure:20,permission_esc:22,idempotency:15,memory_leak:22,boss:15,megaboss:12}, pColor:'#93c5fd', flakyRate:0.65, desc:'Medium, mid range. Best against floating point and permission bugs.' },
  db:          { name:'DB Test',      cost:280, hot:'7', color:'#a16207', icon:'🗄', range:110, fireRate:2200, dmg:{off_by_one:12,floating_point:18,race_condition:65,timezone:15,state_mutation:52,silent_failure:22,permission_esc:20,idempotency:45,memory_leak:28,boss:30,megaboss:25}, pColor:'#ca8a04', flakyRate:0.6, desc:'Slow, short range. Destroys race condition and state mutation bugs.' },
  e2e:         { name:'E2E Test',     cost:300, hot:'8', color:'#f59e0b', icon:'🔄', range:155, fireRate:2800, dmg:{off_by_one:8,floating_point:22,race_condition:55,timezone:12,state_mutation:12,silent_failure:15,permission_esc:45,idempotency:20,memory_leak:20,boss:35,megaboss:28},  pColor:'#fcd34d', flakyRate:1.1,  splash:65, slow:1.8, desc:'Slow, long range. AOE splash on hit and slows bugs. Handles race conditions.' },
  docker:      { name:'Docker',       cost:450, hot:'9', color:'#0ea5e9', icon:'🐳', range:135, fireRate:3800, dmg:{off_by_one:18,floating_point:22,race_condition:30,timezone:18,state_mutation:28,silent_failure:20,permission_esc:65,idempotency:35,memory_leak:30,boss:55,megaboss:45}, pColor:'#7dd3fc', flakyRate:0.3,  freeze:2.0, desc:'Slow, mid range. Isolates bugs for 2s. Destroys permission escalations.' },
  perf:        { name:'Perf Test',    cost:400, hot:'0', color:'#ec4899', icon:'⚡', range:170, fireRate:3500, dmg:{off_by_one:10,floating_point:15,race_condition:45,timezone:20,state_mutation:28,silent_failure:18,permission_esc:32,idempotency:30,memory_leak:40,boss:62,megaboss:55}, pColor:'#f9a8d4', flakyRate:0.4,  splash:80, desc:'Slow, long range. AOE damage. Best vs boss and megaboss.' },
  ai:          { name:'AI Assertion', cost:500, hot:'a', color:'#a855f7', icon:'🤖', range:185, fireRate:1800, dmg:{off_by_one:12,floating_point:14,race_condition:16,timezone:65,state_mutation:15,silent_failure:55,permission_esc:50,idempotency:50,memory_leak:45,boss:28,megaboss:22}, pColor:'#d8b4fe', flakyRate:0.18, desc:'Smart, max range. Catches timezone and silent failure bugs.' }
};
